...
`Glow Worm Luciferin is a firmware` for ESP8266/ESP32 boards designed for [Firefly Luciferin](https://github.com/sblantipodi/firefly_luciferin) software, these two softwares create the perfect `Bias Lighting and Ambient Light system for PC`.  
